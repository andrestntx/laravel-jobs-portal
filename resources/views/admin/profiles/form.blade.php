...
@section('breadcrumbs')
	{!! Breadcrumbs::render('profiles.profile', $profile) !!}
@endsection
...
@section('article')
	{!! Form::model($profile, $formData) !!}
	<div class="mj_postdiv mj_shadow_blue mj_postpage mj_toppadder50 mj_bottompadder50">
		<div class="col-lg-10 col-md-10 col-sm-12 col-xs-12 col-lg-offset-1 col-md-offset-1">
			{!! Field::text('name', ['ph' => 'Nombre del perfil', 'required']) !!}
			{!! Field::text('description', ['ph' => 'Descripción del perfil']) !!}
		</div>
	</div>
            ...
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
                <div class="row">
                    <div class="mj_resume_changeing mj_yellowbg">
                        <a href="{{ route('admin.profiles.index') }}"><i class="fa fa-angle-left"></i>Cancelar</a>
                    </div>
                </div>
            </div>
            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12">
